...
MODEL                = sixdof
MODULES              = rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c sixdof.c sixdof_capi.c sixdof_data.c sixdof_tgtconn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = sixdof.exe
MAKEFILE             = sixdof.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2023a
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2023a
START_DIR            = C:/Users/terry/MICHIGAN/ROB_498-06/ekranoplan/UAVModelGirard
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = sixdof_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/sixdof \
