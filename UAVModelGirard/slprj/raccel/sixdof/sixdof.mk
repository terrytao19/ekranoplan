...
MODEL                   = sixdof
MODULES                 = rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c sixdof.c sixdof_capi.c sixdof_data.c sixdof_tgtconn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = sixdof
MAKEFILE                = sixdof.mk
MATLAB_ROOT             = /Applications/MATLAB_R2023b.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2023b.app
START_DIR               = /Users/jacob/Desktop/ROB\ 599\ AV/ekranoplan/UAVModelGirard
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 12
COMPUTER                = MACA64
